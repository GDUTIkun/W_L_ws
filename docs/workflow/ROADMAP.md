...
| 36 | Hip-common-safe rolling realization repair | review | [Phase 46](phases/46-hip-common-safe-rolling-realization-repair/REVIEW.md) | REWORK：nominal hip-common 保留使 EQ PASS，但限制 QP incremental hip-common 后 actual cross 仍为 `-4.2950569`（仅降低0.000845%）；slip authority保留，DG46I-AUTH FAIL，不进入 REAL/SHORT/10 s |
