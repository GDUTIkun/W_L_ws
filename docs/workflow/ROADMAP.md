...
| 38 | Weighted-WBC / QP realization closure | active | [Phase 48](phases/48-weighted-wbc-qp-realization-closure/PLAN.md) | P48-T01–T04 PASS；hard infeasibility归因为 primitive-hard-law material structural limitation；G2仍 PARTIAL，P48-T05 尚未开始 |
