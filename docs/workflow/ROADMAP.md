...
| 36 | Hip-common-safe rolling realization repair | review | [Phase 46](phases/46-hip-common-safe-rolling-realization-repair/REVIEW.md) | REWORK/P46-E：静态删除 hip-common direction 后 compatible-H0 actual `ddxi_L/R=+0.0785/+0.1603`，DG46-EQ FAIL；严格停止，AUTH/REAL/SHORT/10 s/reaudit未进入 |
