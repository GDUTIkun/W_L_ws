...
| 34 | WBC-to-plant constrained rolling realization audit | review | [Phase 44](phases/44-wbc-to-plant-constrained-rolling-realization-audit/REVIEW.md) | REWORK/P44-U：task/affine acceleration/reduced contact/rolling/C-decomposition与fresh replay通过；late-snapshot authority矩阵不满足冻结对称/半幅门，provisional evidence为多层失效但不得升格P44-E |
